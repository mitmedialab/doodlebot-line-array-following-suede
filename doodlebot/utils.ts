...
export const base64ToInt32Array = async (base64: string) => {
...
export const makeWebsocket = (ip: string, path: string) =>
  new WebSocket(`wss://${ip}${path}`);
...
export const convertSvgUint8ArrayToPng = async (
  uint8Array: AllowSharedBufferSource,
  width: number,
  height: number
) => {
